...
QVector<double> Utility::linspace(double start, double end, int num) //po uzoru na pythonovu funkciju linspace, vraca vector jednoliko rasporedenih brojeva u zadanom intervalu
{
