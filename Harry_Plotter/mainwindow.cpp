...
QPointF MainWindow::transform(QPointF point) //transformira koordinate tocke u koordinate potrebne za iscrtavanje na sceni
{
...
void MainWindow::plot(bool automatic) //argument automatic - true ako se x i y range racunaju automatski, inace false

{
    ...
    auto[system_Info_, grid_] = system->initialize(scene, xStart, xEnd, yStart, yEnd);
