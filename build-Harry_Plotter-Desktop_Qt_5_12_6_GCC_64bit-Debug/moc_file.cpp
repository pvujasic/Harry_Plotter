...
QT_MOC_LITERAL(1, 5, 16), // "deleteFileSignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "File*"
QT_MOC_LITERAL(4, 29, 4), // "file"
QT_MOC_LITERAL(5, 34, 21) // "on_deleteFile_clicked"

    },
    "File\0deleteFileSignal\0\0File*\0file\0"
...
void File::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteFileSignal((*reinterpret_cast< File*(*)>(_a[1]))); break;
        case 1: _t->on_deleteFile_clicked(); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< File* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (File::*)(File * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&File::deleteFileSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void File::deleteFileSignal(File * _t1)
{
