...
private slots:
    ...
    void on_gridBox_stateChanged(int);
    ...
    void on_styleBox_currentIndexChanged(int);

    void on_xFrom_valueChanged(double);

    void on_xTo_valueChanged(double);

    void on_yFrom_valueChanged(double);

    void on_yTo_valueChanged(double);

    void on_pointsNumber_valueChanged(int);
