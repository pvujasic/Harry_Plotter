...
public:
    ...
    void setupUi(QWidget *File)
    {
        ...
        File->setMinimumSize(QSize(211, 26));
        QPalette palette;
        ...
        fileLabel->setGeometry(QRect(10, 0, 151, 20));
        fileLabel->setStyleSheet(QString::fromUtf8("color: #7ddb9b"));
        deleteFile = new QPushButton(File);
        deleteFile->setObjectName(QString::fromUtf8("deleteFile"));
        deleteFile->setGeometry(QRect(180, 0, 31, 25));
    ...
    void retranslateUi(QWidget *File)
    {
        ...
        fileLabel->setText(QApplication::translate("File", "file.txt", nullptr));
        deleteFile->setText(QApplication::translate("File", "X", nullptr));
    } // retranslateUi
