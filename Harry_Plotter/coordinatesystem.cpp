...
std::tuple<std::tuple<double, double, double, double>, QGraphicsItemGroup*> coordinateSystem::initialize(QGraphicsScene *scene, double xStart, double xEnd, double yStart, double yEnd)
{
